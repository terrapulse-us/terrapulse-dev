...
const _TRAIL_DATA: TrailInput[] = [
  ...
  // ── Additional Hiking Trails (all 50 states) ─────────────────────────────
  // AK
  { id: "hike-ak-1", title: "Chilkoot Trail",                     state: "AK", coords: { latitude: 59.4886,  longitude: -135.4167 }, difficulty: "9/10 Extreme",    difficultyRating: 9,  size: "Foot Traffic", suspension: "N/A", region: "Klondike Gold Rush NHP",              category: "hiking", distanceMi: 16.5, elevGainFt: 3700, estimatedTimeHours: 72, petFriendly: false, permitRequired: true  },
  { id: "hike-ak-2", title: "Harding Icefield Trail",             state: "AK", coords: { latitude: 60.1894,  longitude: -149.6394 }, difficulty: "8/10 Very Hard",  difficultyRating: 8,  size: "Foot Traffic", suspension: "N/A", region: "Kenai Fjords National Park",          category: "hiking", distanceMi: 4.0,  elevGainFt: 3500, estimatedTimeHours: 7,  petFriendly: false, permitRequired: false },
  // AL
  { id: "hike-al-1", title: "Walls of Jericho",                   state: "AL", coords: { latitude: 34.7456,  longitude: -86.0136  }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Jackson County",                      category: "hiking", distanceMi: 3.3,  elevGainFt: 800,  estimatedTimeHours: 4,  petFriendly: true,  permitRequired: false },
  // AR
  { id: "hike-ar-1", title: "Whitaker Point (Hawksbill Crag)",    state: "AR", coords: { latitude: 35.9622,  longitude: -93.1938  }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Ozark National Forest",               category: "hiking", distanceMi: 1.5,  elevGainFt: 400,  estimatedTimeHours: 2,  petFriendly: true,  permitRequired: false },
  // CA (more)
  { id: "hike-ca-3", title: "Mist Trail to Nevada Fall",          state: "CA", coords: { latitude: 37.7163,  longitude: -119.5532 }, difficulty: "6/10 Challenging", difficultyRating: 6,  size: "Foot Traffic", suspension: "N/A", region: "Yosemite National Park",              category: "hiking", distanceMi: 3.0,  elevGainFt: 2000, estimatedTimeHours: 5,  petFriendly: false, permitRequired: true  },
  { id: "hike-ca-4", title: "Lost Coast Trail",                   state: "CA", coords: { latitude: 40.2869,  longitude: -124.3578 }, difficulty: "8/10 Very Hard",  difficultyRating: 8,  size: "Foot Traffic", suspension: "N/A", region: "King Range National Conservation Area", category: "hiking", distanceMi: 24.6, elevGainFt: 4000, estimatedTimeHours: 72, petFriendly: true,  permitRequired: true  },
  // CO (more)
  { id: "hike-co-2", title: "Mount Elbert",                       state: "CO", coords: { latitude: 39.1177,  longitude: -106.4453 }, difficulty: "8/10 Very Hard",  difficultyRating: 8,  size: "Foot Traffic", suspension: "N/A", region: "San Isabel National Forest",          category: "hiking", distanceMi: 4.5,  elevGainFt: 4700, estimatedTimeHours: 8,  petFriendly: true,  permitRequired: false },
  { id: "hike-co-3", title: "Sky Pond",                           state: "CO", coords: { latitude: 40.3125,  longitude: -105.6475 }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Rocky Mountain National Park",        category: "hiking", distanceMi: 4.5,  elevGainFt: 1780, estimatedTimeHours: 5,  petFriendly: false, permitRequired: true  },
  // CT
  { id: "hike-ct-1", title: "Bear Mountain (CT Highpoint)",       state: "CT", coords: { latitude: 41.9967,  longitude: -73.4347  }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Salisbury",                           category: "hiking", distanceMi: 3.8,  elevGainFt: 1680, estimatedTimeHours: 5,  petFriendly: true,  permitRequired: false },
  // DE
  { id: "hike-de-1", title: "Brandywine Creek Trail",             state: "DE", coords: { latitude: 39.8140,  longitude: -75.5810  }, difficulty: "2/10 Easy",       difficultyRating: 2,  size: "Foot Traffic", suspension: "N/A", region: "Brandywine Creek State Park",         category: "hiking", distanceMi: 3.7,  elevGainFt: 150,  estimatedTimeHours: 2,  petFriendly: true,  permitRequired: false },
  // FL
  { id: "hike-fl-1", title: "Florida Trail — Ocala Segment",      state: "FL", coords: { latitude: 29.2219,  longitude: -81.7476  }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Ocala National Forest",               category: "hiking", distanceMi: 13.5, elevGainFt: 200,  estimatedTimeHours: 7,  petFriendly: true,  permitRequired: false },
  // GA (more)
  { id: "hike-ga-2", title: "Blood Mountain",                     state: "GA", coords: { latitude: 34.7423,  longitude: -83.9253  }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Chattahoochee National Forest",       category: "hiking", distanceMi: 2.1,  elevGainFt: 1600, estimatedTimeHours: 4,  petFriendly: true,  permitRequired: false },
  // HI (more)
  { id: "hike-hi-2", title: "Diamond Head Crater",                state: "HI", coords: { latitude: 21.2570,  longitude: -157.8051 }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Diamond Head State Monument",         category: "hiking", distanceMi: 0.8,  elevGainFt: 560,  estimatedTimeHours: 2,  petFriendly: false, permitRequired: true  },
  // ID
  { id: "hike-id-1", title: "Sawtooth Lake",                      state: "ID", coords: { latitude: 43.9408,  longitude: -114.8583 }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Sawtooth National Recreation Area",   category: "hiking", distanceMi: 4.5,  elevGainFt: 1700, estimatedTimeHours: 5,  petFriendly: true,  permitRequired: false },
  // IL
  { id: "hike-il-1", title: "Garden of the Gods",                 state: "IL", coords: { latitude: 37.5961,  longitude: -88.3989  }, difficulty: "2/10 Easy",       difficultyRating: 2,  size: "Foot Traffic", suspension: "N/A", region: "Shawnee National Forest",             category: "hiking", distanceMi: 1.5,  elevGainFt: 300,  estimatedTimeHours: 2,  petFriendly: true,  permitRequired: false },
  // IN
  { id: "hike-in-1", title: "Clifty Falls Canyon Loop",           state: "IN", coords: { latitude: 38.7519,  longitude: -85.4267  }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Clifty Falls State Park",             category: "hiking", distanceMi: 2.5,  elevGainFt: 400,  estimatedTimeHours: 3,  petFriendly: true,  permitRequired: false },
  // IA
  { id: "hike-ia-1", title: "Pikes Peak Loop",                    state: "IA", coords: { latitude: 43.0794,  longitude: -91.3481  }, difficulty: "2/10 Easy",       difficultyRating: 2,  size: "Foot Traffic", suspension: "N/A", region: "Pikes Peak State Park",               category: "hiking", distanceMi: 2.0,  elevGainFt: 400,  estimatedTimeHours: 2,  petFriendly: true,  permitRequired: false },
  // KS
  { id: "hike-ks-1", title: "Konza Prairie Nature Trail",         state: "KS", coords: { latitude: 39.0890,  longitude: -96.5748  }, difficulty: "2/10 Easy",       difficultyRating: 2,  size: "Foot Traffic", suspension: "N/A", region: "Konza Prairie Biological Station",    category: "hiking", distanceMi: 4.1,  elevGainFt: 300,  estimatedTimeHours: 3,  petFriendly: false, permitRequired: false },
  // KY
  { id: "hike-ky-1", title: "Natural Bridge (Red River Gorge)",   state: "KY", coords: { latitude: 37.7786,  longitude: -83.6806  }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Red River Gorge Geological Area",     category: "hiking", distanceMi: 1.75, elevGainFt: 600,  estimatedTimeHours: 2,  petFriendly: true,  permitRequired: false },
  // LA
  { id: "hike-la-1", title: "Wild Azalea Trail",                  state: "LA", coords: { latitude: 31.4264,  longitude: -92.8539  }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Kisatchie National Forest",           category: "hiking", distanceMi: 13.5, elevGainFt: 700,  estimatedTimeHours: 8,  petFriendly: true,  permitRequired: false },
  // ME
  { id: "hike-me-1", title: "Precipice Trail",                    state: "ME", coords: { latitude: 44.3545,  longitude: -68.2026  }, difficulty: "7/10 Hard",       difficultyRating: 7,  size: "Foot Traffic", suspension: "N/A", region: "Acadia National Park",                category: "hiking", distanceMi: 1.6,  elevGainFt: 1050, estimatedTimeHours: 3,  petFriendly: false, permitRequired: false },
  { id: "hike-me-2", title: "Mt. Katahdin (AT Terminus)",         state: "ME", coords: { latitude: 45.9044,  longitude: -68.9218  }, difficulty: "10/10 Hardcore",  difficultyRating: 10, size: "Foot Traffic", suspension: "N/A", region: "Baxter State Park",                   category: "hiking", distanceMi: 5.2,  elevGainFt: 4200, estimatedTimeHours: 10, petFriendly: false, permitRequired: true  },
  // MD
  { id: "hike-md-1", title: "Maryland Heights",                   state: "MD", coords: { latitude: 39.3217,  longitude: -77.7330  }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Harpers Ferry NHP",                   category: "hiking", distanceMi: 3.6,  elevGainFt: 1200, estimatedTimeHours: 4,  petFriendly: true,  permitRequired: false },
  // MA
  { id: "hike-ma-1", title: "Mount Greylock",                     state: "MA", coords: { latitude: 42.6371,  longitude: -73.1663  }, difficulty: "6/10 Challenging", difficultyRating: 6,  size: "Foot Traffic", suspension: "N/A", region: "Mt. Greylock State Reservation",      category: "hiking", distanceMi: 4.0,  elevGainFt: 2500, estimatedTimeHours: 6,  petFriendly: true,  permitRequired: false },
  // MI
  { id: "hike-mi-1", title: "Pictured Rocks Lakeshore Trail",     state: "MI", coords: { latitude: 46.5577,  longitude: -86.5442  }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Pictured Rocks National Lakeshore",   category: "hiking", distanceMi: 21.0, elevGainFt: 3000, estimatedTimeHours: 48, petFriendly: true,  permitRequired: true  },
  // MN
  { id: "hike-mn-1", title: "Superior Hiking Trail — Lutsen",     state: "MN", coords: { latitude: 47.6381,  longitude: -90.7050  }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Superior National Forest",            category: "hiking", distanceMi: 8.0,  elevGainFt: 2500, estimatedTimeHours: 6,  petFriendly: true,  permitRequired: false },
  // MS
  { id: "hike-ms-1", title: "Tishomingo Swinging Bridge Trail",   state: "MS", coords: { latitude: 34.6269,  longitude: -88.1964  }, difficulty: "2/10 Easy",       difficultyRating: 2,  size: "Foot Traffic", suspension: "N/A", region: "Tishomingo State Park",               category: "hiking", distanceMi: 1.5,  elevGainFt: 200,  estimatedTimeHours: 2,  petFriendly: true,  permitRequired: false },
  // MO
  { id: "hike-mo-1", title: "Mina Sauk Falls & Taum Sauk Mtn.",   state: "MO", coords: { latitude: 37.5692,  longitude: -90.7239  }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Taum Sauk Mountain State Park",       category: "hiking", distanceMi: 5.0,  elevGainFt: 600,  estimatedTimeHours: 3,  petFriendly: true,  permitRequired: false },
  // MT (more)
  { id: "hike-mt-2", title: "Grinnell Glacier Trail",             state: "MT", coords: { latitude: 48.7958,  longitude: -113.6483 }, difficulty: "6/10 Challenging", difficultyRating: 6,  size: "Foot Traffic", suspension: "N/A", region: "Glacier National Park",               category: "hiking", distanceMi: 5.5,  elevGainFt: 1600, estimatedTimeHours: 7,  petFriendly: false, permitRequired: false },
  // NE
  { id: "hike-ne-1", title: "Scotts Bluff Summit Trail",          state: "NE", coords: { latitude: 41.8320,  longitude: -103.7067 }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Scotts Bluff National Monument",      category: "hiking", distanceMi: 3.5,  elevGainFt: 800,  estimatedTimeHours: 3,  petFriendly: true,  permitRequired: false },
  // NV
  { id: "hike-nv-1", title: "Wheeler Peak Trail (Great Basin)",   state: "NV", coords: { latitude: 38.9908,  longitude: -114.3000 }, difficulty: "7/10 Hard",       difficultyRating: 7,  size: "Foot Traffic", suspension: "N/A", region: "Great Basin National Park",           category: "hiking", distanceMi: 4.4,  elevGainFt: 2900, estimatedTimeHours: 7,  petFriendly: false, permitRequired: false },
  // NH
  { id: "hike-nh-1", title: "Franconia Ridge Loop",               state: "NH", coords: { latitude: 44.1506,  longitude: -71.6703  }, difficulty: "8/10 Very Hard",  difficultyRating: 8,  size: "Foot Traffic", suspension: "N/A", region: "White Mountain National Forest",      category: "hiking", distanceMi: 4.5,  elevGainFt: 3900, estimatedTimeHours: 7,  petFriendly: true,  permitRequired: false },
  { id: "hike-nh-2", title: "Mt. Washington via Tuckerman Ravine", state: "NH", coords: { latitude: 44.2718, longitude: -71.3034  }, difficulty: "9/10 Extreme",    difficultyRating: 9,  size: "Foot Traffic", suspension: "N/A", region: "White Mountain National Forest",      category: "hiking", distanceMi: 4.2,  elevGainFt: 4250, estimatedTimeHours: 8,  petFriendly: false, permitRequired: false },
  // NJ
  { id: "hike-nj-1", title: "Sunfish Pond via AT",                state: "NJ", coords: { latitude: 41.0028,  longitude: -74.9925  }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Delaware Water Gap NRA",              category: "hiking", distanceMi: 4.0,  elevGainFt: 1100, estimatedTimeHours: 4,  petFriendly: true,  permitRequired: false },
  // NM
  { id: "hike-nm-1", title: "Wheeler Peak (NM Highpoint)",        state: "NM", coords: { latitude: 36.5567,  longitude: -105.4175 }, difficulty: "8/10 Very Hard",  difficultyRating: 8,  size: "Foot Traffic", suspension: "N/A", region: "Carson National Forest",              category: "hiking", distanceMi: 7.5,  elevGainFt: 3600, estimatedTimeHours: 10, petFriendly: true,  permitRequired: false },
  { id: "hike-nm-2", title: "Kasha-Katuwe Tent Rocks",            state: "NM", coords: { latitude: 35.6707,  longitude: -106.3853 }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Kasha-Katuwe Tent Rocks NM",         category: "hiking", distanceMi: 1.5,  elevGainFt: 630,  estimatedTimeHours: 2,  petFriendly: false, permitRequired: true  },
  // NY
  { id: "hike-ny-1", title: "Algonquin Peak (Adirondacks)",       state: "NY", coords: { latitude: 44.1414,  longitude: -73.9878  }, difficulty: "8/10 Very Hard",  difficultyRating: 8,  size: "Foot Traffic", suspension: "N/A", region: "Adirondack Park",                     category: "hiking", distanceMi: 4.3,  elevGainFt: 2936, estimatedTimeHours: 7,  petFriendly: true,  permitRequired: false },
  { id: "hike-ny-2", title: "Breakneck Ridge",                    state: "NY", coords: { latitude: 41.4433,  longitude: -73.9828  }, difficulty: "6/10 Challenging", difficultyRating: 6,  size: "Foot Traffic", suspension: "N/A", region: "Hudson Highlands",                    category: "hiking", distanceMi: 2.0,  elevGainFt: 1200, estimatedTimeHours: 3,  petFriendly: true,  permitRequired: false },
  // NC
  { id: "hike-nc-1", title: "Black Balsam Knob",                  state: "NC", coords: { latitude: 35.3297,  longitude: -82.8794  }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Pisgah National Forest",              category: "hiking", distanceMi: 2.8,  elevGainFt: 1000, estimatedTimeHours: 3,  petFriendly: true,  permitRequired: false },
  { id: "hike-nc-2", title: "Table Rock (Linville Gorge)",         state: "NC", coords: { latitude: 35.8828,  longitude: -81.8856  }, difficulty: "6/10 Challenging", difficultyRating: 6,  size: "Foot Traffic", suspension: "N/A", region: "Pisgah National Forest",              category: "hiking", distanceMi: 2.3,  elevGainFt: 1100, estimatedTimeHours: 3,  petFriendly: true,  permitRequired: true  },
  // ND
  { id: "hike-nd-1", title: "Maah Daah Hey Trail",                state: "ND", coords: { latitude: 46.9174,  longitude: -102.7426 }, difficulty: "6/10 Challenging", difficultyRating: 6,  size: "Foot Traffic", suspension: "N/A", region: "Theodore Roosevelt NP",               category: "hiking", distanceMi: 25.0, elevGainFt: 3000, estimatedTimeHours: 48, petFriendly: true,  permitRequired: false },
  // OH
  { id: "hike-oh-1", title: "Conkles Hollow Gorge Trail",         state: "OH", coords: { latitude: 39.4406,  longitude: -82.5661  }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Hocking Hills State Park",            category: "hiking", distanceMi: 1.75, elevGainFt: 500,  estimatedTimeHours: 2,  petFriendly: true,  permitRequired: false },
  // OK
  { id: "hike-ok-1", title: "Black Mesa",                         state: "OK", coords: { latitude: 36.9317,  longitude: -102.9944 }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Black Mesa State Park",               category: "hiking", distanceMi: 4.2,  elevGainFt: 700,  estimatedTimeHours: 4,  petFriendly: true,  permitRequired: false },
  // OR (more)
  { id: "hike-or-2", title: "Timberline Trail (Mt. Hood Loop)",   state: "OR", coords: { latitude: 45.3311,  longitude: -121.7113 }, difficulty: "9/10 Extreme",    difficultyRating: 9,  size: "Foot Traffic", suspension: "N/A", region: "Mt. Hood National Forest",            category: "hiking", distanceMi: 23.6, elevGainFt: 9000, estimatedTimeHours: 72, petFriendly: true,  permitRequired: false },
  // PA
  { id: "hike-pa-1", title: "Ricketts Glen Falls Trail",          state: "PA", coords: { latitude: 41.3256,  longitude: -76.2820  }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Ricketts Glen State Park",            category: "hiking", distanceMi: 3.4,  elevGainFt: 1000, estimatedTimeHours: 4,  petFriendly: true,  permitRequired: false },
  // RI
  { id: "hike-ri-1", title: "Cliff Walk",                         state: "RI", coords: { latitude: 41.4901,  longitude: -71.3064  }, difficulty: "2/10 Easy",       difficultyRating: 2,  size: "Foot Traffic", suspension: "N/A", region: "Newport",                             category: "hiking", distanceMi: 3.5,  elevGainFt: 150,  estimatedTimeHours: 3,  petFriendly: true,  permitRequired: false },
  // SC
  { id: "hike-sc-1", title: "Table Rock Summit Trail",            state: "SC", coords: { latitude: 35.0275,  longitude: -82.6994  }, difficulty: "6/10 Challenging", difficultyRating: 6,  size: "Foot Traffic", suspension: "N/A", region: "Table Rock State Park",               category: "hiking", distanceMi: 3.6,  elevGainFt: 2000, estimatedTimeHours: 5,  petFriendly: true,  permitRequired: false },
  // SD
  { id: "hike-sd-1", title: "Black Elk Peak",                     state: "SD", coords: { latitude: 43.8638,  longitude: -103.5327 }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Black Hills National Forest",         category: "hiking", distanceMi: 3.6,  elevGainFt: 1100, estimatedTimeHours: 4,  petFriendly: true,  permitRequired: false },
  // TN
  { id: "hike-tn-1", title: "Alum Cave Trail",                    state: "TN", coords: { latitude: 35.6378,  longitude: -83.4464  }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Great Smoky Mountains NP",            category: "hiking", distanceMi: 2.3,  elevGainFt: 1400, estimatedTimeHours: 4,  petFriendly: false, permitRequired: false },
  { id: "hike-tn-2", title: "Clingmans Dome",                     state: "TN", coords: { latitude: 35.5629,  longitude: -83.4985  }, difficulty: "2/10 Easy",       difficultyRating: 2,  size: "Foot Traffic", suspension: "N/A", region: "Great Smoky Mountains NP",            category: "hiking", distanceMi: 0.5,  elevGainFt: 330,  estimatedTimeHours: 1,  petFriendly: false, permitRequired: false },
  // TX
  { id: "hike-tx-1", title: "Lost Mine Trail",                    state: "TX", coords: { latitude: 29.2636,  longitude: -103.2978 }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Big Bend National Park",              category: "hiking", distanceMi: 2.4,  elevGainFt: 1100, estimatedTimeHours: 3,  petFriendly: false, permitRequired: false },
  { id: "hike-tx-2", title: "Guadalupe Peak Trail",               state: "TX", coords: { latitude: 31.8897,  longitude: -104.8601 }, difficulty: "7/10 Hard",       difficultyRating: 7,  size: "Foot Traffic", suspension: "N/A", region: "Guadalupe Mountains NP",              category: "hiking", distanceMi: 4.2,  elevGainFt: 3000, estimatedTimeHours: 7,  petFriendly: false, permitRequired: false },
  // UT (more)
  { id: "hike-ut-2", title: "Zion Narrows (Bottom-Up)",           state: "UT", coords: { latitude: 37.2979,  longitude: -112.9479 }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Zion National Park",                  category: "hiking", distanceMi: 5.0,  elevGainFt: 450,  estimatedTimeHours: 5,  petFriendly: false, permitRequired: false },
  { id: "hike-ut-3", title: "Delicate Arch",                      state: "UT", coords: { latitude: 38.7357,  longitude: -109.4994 }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Arches National Park",                category: "hiking", distanceMi: 1.5,  elevGainFt: 480,  estimatedTimeHours: 2,  petFriendly: false, permitRequired: false },
  // VA
  { id: "hike-va-1", title: "McAfee Knob (AT)",                   state: "VA", coords: { latitude: 37.3921,  longitude: -80.0283  }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Jefferson National Forest",           category: "hiking", distanceMi: 4.4,  elevGainFt: 1700, estimatedTimeHours: 5,  petFriendly: true,  permitRequired: false },
  { id: "hike-va-2", title: "Old Rag Mountain",                   state: "VA", coords: { latitude: 38.5606,  longitude: -78.3325  }, difficulty: "7/10 Hard",       difficultyRating: 7,  size: "Foot Traffic", suspension: "N/A", region: "Shenandoah National Park",            category: "hiking", distanceMi: 4.6,  elevGainFt: 2200, estimatedTimeHours: 5,  petFriendly: false, permitRequired: true  },
  // VT
  { id: "hike-vt-1", title: "Mt. Mansfield via Long Trail",       state: "VT", coords: { latitude: 44.5439,  longitude: -72.8142  }, difficulty: "7/10 Hard",       difficultyRating: 7,  size: "Foot Traffic", suspension: "N/A", region: "Green Mountain National Forest",      category: "hiking", distanceMi: 3.3,  elevGainFt: 2600, estimatedTimeHours: 6,  petFriendly: true,  permitRequired: false },
  { id: "hike-vt-2", title: "Camel's Hump",                       state: "VT", coords: { latitude: 44.3186,  longitude: -72.8855  }, difficulty: "7/10 Hard",       difficultyRating: 7,  size: "Foot Traffic", suspension: "N/A", region: "Green Mountain National Forest",      category: "hiking", distanceMi: 3.4,  elevGainFt: 2700, estimatedTimeHours: 6,  petFriendly: true,  permitRequired: false },
  // WA (more)
  { id: "hike-wa-2", title: "Camp Muir (Mt. Rainier)",            state: "WA", coords: { latitude: 46.7860,  longitude: -121.7350 }, difficulty: "9/10 Extreme",    difficultyRating: 9,  size: "Foot Traffic", suspension: "N/A", region: "Mt. Rainier National Park",           category: "hiking", distanceMi: 4.5,  elevGainFt: 4600, estimatedTimeHours: 8,  petFriendly: false, permitRequired: false },
  { id: "hike-wa-3", title: "Hurricane Ridge",                    state: "WA", coords: { latitude: 47.9691,  longitude: -123.4997 }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Olympic National Park",               category: "hiking", distanceMi: 3.0,  elevGainFt: 700,  estimatedTimeHours: 3,  petFriendly: false, permitRequired: false },
  // WV
  { id: "hike-wv-1", title: "Seneca Rocks",                       state: "WV", coords: { latitude: 38.8322,  longitude: -79.3728  }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Spruce Knob-Seneca Rocks NRA",        category: "hiking", distanceMi: 1.5,  elevGainFt: 872,  estimatedTimeHours: 2,  petFriendly: true,  permitRequired: false },
  { id: "hike-wv-2", title: "Dolly Sods Wilderness",              state: "WV", coords: { latitude: 38.9997,  longitude: -79.2653  }, difficulty: "4/10 Moderate",   difficultyRating: 4,  size: "Foot Traffic", suspension: "N/A", region: "Monongahela National Forest",         category: "hiking", distanceMi: 7.0,  elevGainFt: 1200, estimatedTimeHours: 5,  petFriendly: true,  permitRequired: false },
  // WI
  { id: "hike-wi-1", title: "Ice Age Trail — Kettle Moraine",     state: "WI", coords: { latitude: 43.1889,  longitude: -88.0331  }, difficulty: "3/10 Beginner",   difficultyRating: 3,  size: "Foot Traffic", suspension: "N/A", region: "Kettle Moraine State Forest",         category: "hiking", distanceMi: 9.5,  elevGainFt: 600,  estimatedTimeHours: 5,  petFriendly: true,  permitRequired: false },
  // WY (more)
  { id: "hike-wy-2", title: "Mt. Washburn via Dunraven Pass",     state: "WY", coords: { latitude: 44.7946,  longitude: -110.4319 }, difficulty: "5/10 Moderate",   difficultyRating: 5,  size: "Foot Traffic", suspension: "N/A", region: "Yellowstone National Park",           category: "hiking", distanceMi: 3.0,  elevGainFt: 1400, estimatedTimeHours: 4,  petFriendly: false, permitRequired: false },
];
