 ...
 *
 *   The previous perl rename approach (#x → ___x) still produced public field
 *   declarations, which hermesc ALSO rejects.
 *
 * PATH NOTE:
 *   This script lives at <workspaceRoot>/scripts/transform-bundle.js.
 *   @babel/* packages are devDependencies of @workspace/mobile, so they are
 *   hoisted into <workspaceRoot>/artifacts/mobile/node_modules/@babel/.
 *
 * USAGE: node transform-bundle.js <path-to-bundle.js>
 */

const path = require('path');
const fs   = require('fs');

// scripts/ is directly under workspaceRoot; artifacts/mobile is a sibling dir.
